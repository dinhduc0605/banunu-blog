...
with open("/home/ubuntu/banunu-blog/content/posts/nhat-ky-so-2026-dua-bo-nao-thu-hai-ve-chay-local/index.md", "w", encoding="utf-8") as f:
    f.write(content)

print("Draft rewritten successfully")
